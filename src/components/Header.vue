<template>
    <header>
        <a href="/"><img alt="Vue logo" src="../assets/logo.svg" width="32" height="32" /></a>
        <nav>
            <ul>
